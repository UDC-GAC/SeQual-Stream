...
public class FASTAReaderUtils extends ReaderUtils {
...
public void run() {
    	...
    	try {
    		...
    		while(true) {
        		...
        		List<FASTAReaderWorker> workerList = new ArrayList<>();
        		
        		for (int i = 0; i < num_readers; i++) {
        			FASTAReaderWorker worker = new FASTAReaderWorker();
        		...
        		for (FASTAReaderWorker worker: workerList) {
        			worker.join();
        		}
