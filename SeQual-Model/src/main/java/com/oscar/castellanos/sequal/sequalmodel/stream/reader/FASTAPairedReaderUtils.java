...
public class FASTAPairedReaderUtils extends ReaderUtils {
    ...
    public void run() {
    	...
    	try {
    		...
    		while(true) {
        		...
        		List<FASTAPairedReaderWorker> workerList = new ArrayList<>();
        		
        		for (int i = 0; i < num_readers; i++) {
        			FASTAPairedReaderWorker worker = new FASTAPairedReaderWorker();
        		...
        		for (FASTAPairedReaderWorker worker: workerList) {
        			worker.join();
        		}
