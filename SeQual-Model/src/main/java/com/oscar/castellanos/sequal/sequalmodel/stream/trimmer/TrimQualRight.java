...
public class TrimQualRight extends FQTrimmer implements Trimmer {
	 ...
	 * @return the sequence
	 */
	private SequenceWithTimestamp doTrim(SequenceWithTimestamp sequenceWithTimestamp, Double limit) {
	...
	private SequenceWithTimestamp doTrimPair(SequenceWithTimestamp sequenceWithTimestamp, Double limit) {
